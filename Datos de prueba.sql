...
CALL CreateEmpleado("Maria Vargas", "2022-11-12", 1000, 1, 1);
CALL CreateBono(15000, "2022-7-15", 1);
CALL createEncargo("2022-9-17", 1, 45, 1, 1);
...
CALL createCliente("Melissa", "87117264", "meli2@gmail.com", "50 norte de...", 1, 1);
CALL CreateProducto("Leche dos pinos 200ml", 1);
CALL createPromocion("2008-09-16", "2008-09-20", 5, 1);
CALL CreateTipoEnvio("fisico", 0.1);
CALL CreatePedido("2008-8-16", 1, 1, 1, 1);
CALL createDetalle(9, 1, 1);
#CALL createEncargoXProducto(1, 1, 1, 5000);
CALL createProductoXProveedor(1, 1, 49, "2003-8-9", "2004-7-10", 29.0);
...
CALL consultarEmpleados(1, null, null, null, null, null);
CALL consultarProveedores("leche dos pinos 200ml", null);
