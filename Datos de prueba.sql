...
CALL CreateProveedor ("Dos Pinos", "2567-1629", 4);
...
CALL CreateTipoEnvio("fisico", 0.0);
CALL CreateTipoEnvio("domicilio", 0.01);
CALL CreatePedido("2008-8-16", 1, 1, 1, 1);
CALL createEncargoXProducto(1, 1, 1, 5000);
CALL createProductoXProveedor(1, 2, 49, "2003-8-9", "2037-10-25", 10.0);
